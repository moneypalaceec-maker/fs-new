        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <Card className="lg:col-span-2 bg-card/50 backdrop-blur-sm border-white/5 shadow-2xl relative overflow-hidden">
            ...
            <CardContent className="p-8 h-[400px] flex flex-col items-center justify-center relative z-10 perspective-[1000px]">
              <div
                className="relative w-48 h-48 mx-auto mb-8 preserve-3d"
                style={{
              ...
              >
                ...
                <div className="absolute inset-0 backface-hidden rounded-full bg-gradient-to-br from-yellow-400 to-yellow-600 flex items-center justify-center border-[10px] border-yellow-700 shadow-2xl">
                  <div className="w-full h-full rounded-full border-2 border-yellow-300/50 flex flex-col items-center justify-center m-2">
                    <span className="text-4xl font-black text-yellow-900 drop-shadow-md">
                      HEADS
                    </span>
                  </div>
                </div>
                {/* Tails Side */}
                <div
                  className="absolute inset-0 backface-hidden rounded-full bg-gradient-to-br from-slate-300 to-slate-500 flex items-center justify-center border-[10px] border-slate-600 shadow-2xl"
                ...
                >
                  <div className="w-full h-full rounded-full border-2 border-slate-200/50 flex flex-col items-center justify-center m-2">
                    <span className="text-4xl font-black text-slate-800 drop-shadow-md">
                      TAILS
                    </span>
                  </div>
                </div>
          ...
          <Card className="bg-card border-white/5 shadow-xl">
            <CardContent className="p-6 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button
                    ...
                    className={cn(
                      ...
                      choice === "heads"
                        ? "bg-yellow-500 hover:bg-yellow-600 text-yellow-950 border-transparent shadow-[0_0_15px_rgba(234,179,8,0.4)]"
                  ...
                  <Button
                    ...
                    className={cn(
                      "h-14 font-bold text-lg",
                      choice === "tails"
                        ? "bg-slate-400 hover:bg-slate-500 text-slate-950 border-transparent shadow-[0_0_15px_rgba(148,163,184,0.4)]"
                        : "border-white/10 bg-black/20",
                    )}
              ...
              <div className="bg-black/20 rounded-lg p-4 border border-white/5 flex justify-between items-center mt-6">
                ...
                <span className="font-bold text-foreground">2.00x</span>
              </div>
              ...
              <Button
                ...
                disabled={
                  isFlipping ||
                  playCoinflip.isPending ||
                  !wager ||
                  parseFloat(wager) <= 0
                }
              >
                {isFlipping || playCoinflip.isPending ? (
