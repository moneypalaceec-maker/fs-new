      ...
      <div className="max-w-2xl mx-auto space-y-6 animate-in fade-in duration-500">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Required to unlock high limits and withdrawals.
          </p>
        </div>
              ...
              {kyc?.status === "approved" ? (
                <>
                  ...
                  <p className="text-muted-foreground">
                    Your identity has been verified. All platform features are
                    unlocked.
                  </p>
                </>
              ) : (
                <>
                  ...
                  <p className="text-muted-foreground">
                    We are reviewing your documents. This usually takes 1-2
                    hours.
                  </p>
                </>
              )}
              ...
              {kyc?.status === "rejected" && (
                <div className="mt-4 bg-destructive/10 border border-destructive/20 text-destructive p-4 rounded-lg flex gap-3 text-sm">
                  ...
                  <div>
                    ...
                    <p>
                      {kyc.rejectionReason ||
                        "Please submit clearer documents."}
                    </p>
                  </div>
                </div>
              )}
